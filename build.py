...
class ColorSplit(object):
    """Contains colors for Sight and Sight Night themes.

    Args:
        sight (Union[str, ColorSplit]): The Sight theme color from an hexadecimal
            representation or another color split.
        sight_night (Union[str, ColorSplit], optional): The Sight Night theme color from
            an hexadecimal representation or another color split. If None, the Sight
